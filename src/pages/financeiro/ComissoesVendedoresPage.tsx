...
export default function ComissoesVendedoresPage() {
  ...
  return <div className="p-4 md:p-6 space-y-5">
    ...
    {atual&&query.data&&<Detalhes key={atual.venda.id} dados={atual} rateios={query.data.rateios??[]} parametros={query.data.parametros} isAdmin={isAdmin} onClose={()=>setSelecionada(null)}/>}
...
function Detalhes({dados,parametros,isAdmin,onClose,rateios}:{rateios:Record<string,any>[];dados:Calculada;parametros:Parametros;isAdmin:boolean;onClose:()=>void}) {
